    ...
    <li id={@id} class="block p-5 mb-5 bg-white rounded-md shadow draggable">
      <a href="#">
        <div class="flex-justify-between mb-2">
          ...
          <Heroicons.shopping_bag solid class="w-8 h-8 rounded-full mx-auto text-red-500" />
        </div>
      </a>
      ...
      <div>
        ...
        <ul>
          <li :for={order_item <- @card.order_items} class="">
      ...
      <div>
        ...
        <ul class="text-xs">
          ...
          <li :if={@card.status == :DELIVERED} class="flex justify-between mb-1">
            <span class="text-red-500">Delivered at:</span>
